CLASS zcx_48_insufficient_balance_mb DEFINITION INHERITING FROM cx_static_check
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
*****************CONTANTES********************************************
    CONSTANTS:
      BEGIN OF insufficient_balance,
        ...
        msgno TYPE symsgno VALUE '004', " Insufficient balance in your account
...
CLASS zcx_48_insufficient_balance_mb IMPLEMENTATION.
